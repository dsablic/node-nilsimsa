...
import { Nilsimsa } from '../lib/nilsimsa.js'
...
describe('Sample Digests', function() {
	...
	describe('digest', () => {
		...
		it('should return the same digest value for the same input', () => {
			const random_str = 'Lorem ipsum dolor sit amet '.repeat(20)
	...
	describe('compare', () => {
		...
		describe('similarity score against a threshold', () => {
			...
			it('should return a low score for differing input', () => {
				const input1 = 'The first document contains completely different text. '.repeat(30)
				const input2 = 'Another unrelated document with totally separate content. '.repeat(30)
			...
			it('should return a high score for similar input', () => {
				const base_input = 'This is a long document with lots of shared content that will be used to test similarity detection in the Nilsimsa hash algorithm. '.repeat(20)
